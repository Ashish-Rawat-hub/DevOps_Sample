...
infra = {
  "{{env}}" = {
    ...
    webapp_cors_api    = ["https://pdcentraldev.fdbops.com","https://localhost:7026","https://{{prefix}}-{{env}}-webapp-ui.azurewebsites.net"]
    ...
    ip_restriction    = [
    {
      ...
      priority                  = 300
      virtual_network_subnet_id = "/subscriptions/97d730d5-b1c9-4457-8887-694c44c7b10a/resourceGroups/rg-20060000-CoreEUS2-NonProd/providers/Microsoft.Network/virtualNetworks/vnet-10.26.55.128_25-eastus2/subnets/subnet-10.26.55.192_28-FDB-BusSys-WebApp-NonProd"
      ip_address                = null
      action                    = "Allow"
    },
    {
